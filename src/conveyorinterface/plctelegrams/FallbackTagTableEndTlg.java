...
public class FallbackTagTableEndTlg extends AbstractTelegram {
    ...
    public FallbackTagTableEndTlg(int subsystemId, int channelId, int version, int sequenceNumber, int entryCount) {
    ...
    public int getTelegramType() {
        return 156; // Airline Code Table End telegram type
    }
